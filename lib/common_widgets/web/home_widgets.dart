      ...
      children: [
          ...
          children: [
            ...
            Container(
                ...
                child: Padding(
                  ...
                  child: Text("Home",style: NormalTextStyle.customStyle(),),
                )),
            SizedBox(width: 7,),
            MouseRegion(
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text("Login/Register",
                      style:
                          NormalTextStyle.customStyle(fontWeight: FontWeight.bold)),
                ),
              ),
            ),
        ...
        Text(
          ...
          style: CustomTextStyle.customStyle(
              fontSize: 23.sp, letterSpacing: 2, fontWeight: FontWeight.bold),
        ),
        SizedBox(
          height: 8,
        ),
